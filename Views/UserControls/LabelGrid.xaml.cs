...
namespace LabelImg.Views.UserControls
{
    ...
    public partial class LabelGrid : UserControl
    {
        ...
        {
            LabelDataChangedEventArgs newEventArgs = new LabelDataChangedEventArgs(LabelDataChangedEvent, list);
            RaiseEvent(newEventArgs);
        }
        ...
        public void AddCut(int classIndex, double xCenter=0, double yCenter = 0, double xWeight = 0, double yWeight = 0)
        {
            ...
            string name = $"lbl{RandomStringGenerator.Generate(6)}";
        ...
        private void OnControlSizeChanged()
        {
            ...
            foreach (var item in viewModel.CutList)
            {
                Label newLabel = addNewLabel(item.Name);
        ...
        private Label addNewLabel(string lblName, bool isCutPic=false)
        {
            Label newLabel = new Label
            {
                ...
                Content = $"lbl{RandomStringGenerator.Generate(6)}",
    ...
    public class LabelDataChangedEventArgs : RoutedEventArgs
    {
        ...
        public LabelDataChangedEventArgs(RoutedEvent routedEvent, List<CutLabelModel> _list) : base(routedEvent)
        {
            List = _list;
        }
    }
